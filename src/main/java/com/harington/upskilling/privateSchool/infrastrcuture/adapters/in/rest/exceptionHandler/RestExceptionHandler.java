...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleNotFoundException(RecordNotFoundException ex) {
        return new ResponseEntity<ApiErrorResponse>(new ApiErrorResponse(HttpStatus.NOT_FOUND.value(), ex.getMessage(), null), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleDataValidationException(DataValidationException ex) {
        ...
        return new ResponseEntity<ApiErrorResponse>(new ApiErrorResponse(HttpStatus.BAD_REQUEST.value(), ex.getMessage(), null), HttpStatus.BAD_REQUEST);
    }
}
